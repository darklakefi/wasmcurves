...
module.exports = function buildBLS12377(module, _prefix) {
    ...
    function build_mulNR2() {
        ...
        f.addCode(
            // updated (in theory should be -b + au)
            // c.call(f1mPrefix + "_neg", x1, r0),
            // c.call(f1mPrefix + "_copy", x0, r1)
    ...
    function buildFrobeniusMap(n) {
        const F12 = [
            ...
            [
                ...
                // replaced -> p (q) - 1 (by my calculations should end in 6)
                [258664426012969094010652733694893533536393512754914660539884262666720468348340822774968888139573360124440321458172n, 0n],
